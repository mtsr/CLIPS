...
void ClassAbstractPCommand(
  ...
  CLIPSValue *returnValue)
  {
   ...
   mCVSetBoolean(returnValue,(EnvClassAbstractP(theEnv,cls)));
  }
...
void ClassReactivePCommand(
  ...
  CLIPSValue *returnValue)
  {
   ...
   mCVSetBoolean(returnValue,EnvClassReactiveP(theEnv,cls));
  }
...
Defclass *ClassInfoFnxArgs(
   ...
   *inhp = false;
   ...
   clsptr = LookupDefclassByMdlOrScope(theEnv,mCVToString(&theArg));
   if (clsptr == NULL)
     {
